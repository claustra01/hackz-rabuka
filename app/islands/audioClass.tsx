      ...
      if (audioRef && audioClassifier) {
        ...
        scriptNode.onaudioprocess = function (audioProcessingEvent) {
          ...
          if (inputData != undefined) {
            ...
            setResult({
              first:
                categories[0].categoryName + " score: " + categories[0].score,
              second:
                categories[1].categoryName + " score: " + categories[1].score,
              third:
                categories[2].categoryName + " score: " + categories[2].score,
            });
            for (let i = 0; i < 10; i++) {
